...
|--------|---------------|---------------|---------------|----------------|------------------------|
| **LLM**  | 0.126        | 0.095        | 0.069        | 0.423         | 0.100                 |
| **BERT** | 0.446        | 0.405        | 0.291        | 0.807         | 0.138                 |
...
Лучше всего предсказывается класс «Теоретический вопрос» - 99% точности, хуже – «взаимодействие с графом» - 88%.
...
### 5.4 app.smilecloudclassifier.ru 
...
### 5.5 BERT vs LLM: анализ результатов внешенго тестирования 
